...
class DQNAgent(BaseAgent):
    def __init__(self, input_shape, action_space, lr=1e-4, gamma=0.99, buffer_size=10000, batch_size=32):
        ...
        self.model = DQN(input_shape, self.num_actions)
        self.target_model = DQN(input_shape, self.num_actions)
